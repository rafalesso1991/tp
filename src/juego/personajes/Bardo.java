...
public class Bardo  extends Personaje {
    public Bardo(String nombre, Raza raza, int fuerza, int agilidad, int inteligencia, int voluntad, int carisma, int vida) {

        // Llama al Constructor de la clase padre
        super(nombre, raza, Rol.BARDO, fuerza, agilidad, inteligencia, voluntad, carisma, vida);
    }
