...
public class Sacerdote  extends Personaje {
    public Sacerdote(String nombre, Raza raza, int fuerza, int agilidad, int inteligencia, int voluntad, int carisma, int vida) {

        // Llama al Constructor de la clase padre
        super(nombre, raza, Rol.SACERDOTE, fuerza, agilidad, inteligencia, voluntad, carisma, vida);
    }
