...
public class Ladron  extends Personaje {
    public Ladron(String nombre, Raza raza, int fuerza, int agilidad, int inteligencia, int voluntad, int carisma) {

        // Llama al Constructor de la clase padre
        super(nombre, raza, Rol.LADRON, fuerza, agilidad, inteligencia, voluntad, carisma);
    }
